...
import { Container, Group, Text, Anchor, Space, SimpleGrid, Title, Box } from '@mantine/core';
...
export default function StoreFooter({ siteConfig, navData }: StoreFooterProps) {
  ...
  return (
    <Box component="footer" p="xl" mt="xl" style={{ borderTop: '1px solid var(--mantine-color-gray-2)'}}>
      <Container size="xl">
