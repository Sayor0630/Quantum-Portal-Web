...
export default function EditMenuPage() {
  ...
  function handleDragStart(event: DragStartEvent) {
    ...
    setActiveDraggedItemData(findItemRecursive(items, active.id as string)?.item || null);
  }

  function handleDragEnd(event: DragEndEvent) {
    const { active, over } = event;
    setActiveDragId(null); setActiveDraggedItemData(null);
      ...
      <Paper withBorder shadow="md" p="lg" radius="md" pos="relative">
        ...
        <DndContext sensors={sensors} collisionDetection={closestCenter} onDragStart={handleDragStart} onDragEnd={handleDragEnd} modifiers={[restrictToVerticalAxis]}>
            ...
            <DragOverlay dropAnimation={null}>
                {activeDraggedItemData ? <SortableMenuItem item={activeDraggedItemData} onEdit={()=>{}} onDelete={()=>{}} onAddChild={()=>{}} isOverlay={true} level={activeDraggedItemData.parentId === null ? 0 : 1 /* Approximate level for overlay */} /> : null}
            </DragOverlay>
        </DndContext>
